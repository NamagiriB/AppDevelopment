      ...
      <div className="wrapper-left1">
        ...
        <div className="inp1">
          <form action>
            ...
            <input className="inp-left1" type="email" placeholder="mhmmd.rezaei4@gmail.com" />
            <label htmlFor className="pass1">Password </label>
            <i className="fas fa-lock pass1" />
            <input className="inp-left1" type="password" placeholder="8+ characters, 2 numbers" name id />
          </form>
        </div>
